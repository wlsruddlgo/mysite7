...
'''
#django에서 기본적으로 제공해주는 회원관리 어플리케이션에서 User 모델클래스를 연동해 회원가입, 로그인 폼을 정의
...
class SignupForm(forms.ModelForm):
    ...
    #모델클래스에서 사용한 models.XXXFiled와 기능과 이름이 유사함
    #lable  매개변수 : 해당 입력공간의 설명란을 정의하는 매개변수.
    #기본값은 변수명으로 설정되있다.
    #입력란의 순서를 저장하는 변수
    ...
    class Meta:
        ...
        #모델클래스에 정의된 변수를 대상으로 위젯을 적용할 때 사용하는 변수
